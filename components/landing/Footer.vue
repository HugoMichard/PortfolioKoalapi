<template>
  <div class="sm:gap-x-28 gap-x-12 gap-y-12 flex flex-wrap justify-center mt-8">
    ...
    <div>
      ...
      <el-text type="info" class="mt-2"
        >Stay in tune with KoalAPI's latest updates</el-text
      >
      <br />
      <div class="flex sm:flex-nowrap flex-wrap mt-2">
        <el-input
          ...
          class="w-38"
        />
        <el-button class="bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 duration-150 text-white font-medium" @click="subscribeToNewsletter"
          >SUBSCRIBE</el-button
        >
      </div>
    </div>
